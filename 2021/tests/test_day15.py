...
def test_lowest_threat_level():
    grid = _parse_input(auto_read_input())
    threat_level = lowest_threat_level(grid)
    expected_threat_level = 40
    assert threat_level == expected_threat_level


def test_lowest_threat_level_bfs():
    grid = _parse_input(auto_read_input())
    threat_level = lowest_threat_level_bfs(grid)
    expected_threat_level = 40
    assert threat_level == expected_threat_level
...
def test_lowest_threat_level_on_expanded_5x():
    grid = _parse_input(auto_read_input())
    grid = expand_5x(grid)
    threat_level = lowest_threat_level_bfs(grid)
    assert threat_level == 315
